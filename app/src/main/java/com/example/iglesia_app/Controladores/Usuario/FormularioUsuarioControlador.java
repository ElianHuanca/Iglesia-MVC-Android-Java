...
public class FormularioUsuarioControlador extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                     usuarioModelo = new UsuarioModelo(context,id,
                    ...
                    if(id==0){
                        usuarioModelo.agregar(usuarioModelo);
                    }else{
                        usuarioModelo.editar(usuarioModelo);
                    }
