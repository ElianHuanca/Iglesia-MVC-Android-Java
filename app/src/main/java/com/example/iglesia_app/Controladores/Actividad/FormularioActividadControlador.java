...
public class FormularioActividadControlador extends AppCompatActivity {
    Context context;
        ...
        btn_guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if(id==0){
                        actividadModelo.agregar(actividadModelo);
                    }else{
                        actividadModelo.editar(actividadModelo);
                    }
                    Intent intent= new Intent(context, ListaActividadControlador.class);
